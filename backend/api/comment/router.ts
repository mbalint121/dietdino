...
router.delete("/:ID", AuthService.DecodeToken, AuthService.UserExists,AuthService.CommentExists, AuthService.IsUserAuthorOrModeratorOrAdmin, DeleteCommentByID);
